...
import sys
import os
from .types import PluginDefinition, PluginConfig
...
def load_plugins(plugins_list: List[PluginDefinition], plugin_config: PluginConfig, conn: duckdb.DuckDBPyConnection) -> Dict[str, MXCPBasePlugin]:
