...
from .types import AtlassianAuthConfig, HttpTransportConfig
...
class AtlassianOAuthHandler(ExternalOAuthHandler):
    ...
    def __init__(self, atlassian_config: AtlassianAuthConfig, transport_config: Optional[HttpTransportConfig] = None, host: str = "localhost", port: int = 8000):
        ...
        self.scope = atlassian_config.get("scope", "read:me read:jira-work read:jira-user read:confluence-content.all read:confluence-user offline_access")
