...
from .types import DatabaseConfig, PluginDefinition, PluginConfig, SecretDefinition
...
def execute_query_to_dict(conn: duckdb.DuckDBPyConnection, query: str, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
    """
...
class DuckDBSession:
    ...
    def execute_query_to_dict(self, query: str, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
