...
async def execute_endpoint_with_engine(
    *,
    ...
    """Context-aware wrapper around the production endpoint runner."""
...
"""
    ...
    async def test_race_conditions():
        ...
        unique_old_values = {r["old_value"] for r in results}
    ...
    async def test_thread_safe():
        ...
        print("  ✓ All increments were sequential")
...
"""
    ...
    async def test_parallel_subtasks():
        ...
        print("  ✓ All subtasks had access to context")
    ...
    async def test_async_context_propagation():
        ...
        print("  ✓ Context propagated to all nested tasks")
