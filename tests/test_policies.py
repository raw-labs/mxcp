    ...
    def test_parse_output_policies(self):
        ...
        config = {
            "output": [
                ...
                {"condition": "true", "action": "mask_fields", "fields": ["phone"]},
            ]
        }
...
class TestPolicyEnforcement:
    ...
    def test_output_policy_mask_fields(self):
        ...
        output = [
            {"name": "John Doe", "phone": "555-1234", "address": "123 Main St"},
            {"name": "Jane Smith", "phone": "555-5678", "address": "456 Oak Ave"},
        ]
    ...
    def test_output_policy_filter_sensitive_fields(self):
        ...
        # Test data
        data = {"username": "john_doe", "api_key": "secret123", "email": "john@example.com"}

        # Apply policy
        result, action = enforcer.enforce_output_policies(
            user_context=None, output=data, endpoint_def={"return": type_def}
        )
    ...
    def test_filter_sensitive_fields_nested(self):
        ...
        data = {
            "user": {"name": "John", "credentials": {"password": "pass123", "token": "tok456"}},
            "metadata": {"created": "2024-01-01", "secret": "hidden"},
        }
    ...
    def test_filter_sensitive_fields_conditional(self):
        ...
        result, action = enforcer.enforce_output_policies(
            user_context=regular_user, output=data.copy(), endpoint_def={"return": type_def}
        )
        ...
        result, action = enforcer.enforce_output_policies(
            user_context=admin_user, output=data.copy(), endpoint_def={"return": type_def}
        )
        ...
        try:
            ...
            logger.log_event(
                ...
                input_params={
                    "config": {
                        "host": "example.com",
                        "credentials": {"username": "admin", "api_key": "sk-12345"},
                    }
                },
                duration_ms=50,
                endpoint_def=endpoint_def,
