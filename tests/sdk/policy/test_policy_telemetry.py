...
from mxcp.sdk.policy import PolicyEnforcer, PolicySet, PolicyDefinition, PolicyAction, PolicyEnforcementError
from mxcp.sdk.telemetry import configure_telemetry, is_telemetry_enabled, traced_operation, shutdown_telemetry
...
def test_policy_enforcement_creates_telemetry_spans():
    ...
    with traced_operation("test.policy_enforcement") as root_span:
        ...
        filtered_output, action = enforcer.enforce_output_policies(
            user_context, 
            output_data
        )
...
def test_nested_policy_spans():
    ...
    with traced_operation("test.root") as root_span:
        ...
        enforcer.enforce_input_policies(
            user_context, 
            {"param1": "value2", "param2": 50}
        )
