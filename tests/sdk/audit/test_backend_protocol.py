...
async def test_backend_record_writing(backend):
    ...
    schema = AuditSchema(
        ...
        version=1,
        description="Test record writing"
    )
    await backend.create_schema(schema)
...
async def test_backend_record_querying(backend):
    ...
    schema = AuditSchema(
        ...
        version=1,
        description="Test record querying"
    )
    await backend.create_schema(schema)
...
async def test_backend_record_retrieval(backend):
    ...
    schema = AuditSchema(
        ...
        version=1,
        description="Test record retrieval"
    )
    await backend.create_schema(schema)
...
async def test_backend_schema_deactivation(backend):
    ...
    # Create schema
    schema = AuditSchema(
        schema_name="deactivation_test",
        version=1,
        description="Test schema deactivation"
    )
    await backend.create_schema(schema)
...
async def test_backend_time_filtering(backend):
    ...
    schema = AuditSchema(
        ...
        version=1,
        description="Test time filtering"
    )
    await backend.create_schema(schema)
...
async def test_backend_schema_versioning(backend):
    ...
    schema_v1 = AuditSchema(
        ...
        version=1,
        description="Version 1 of schema"
    )
