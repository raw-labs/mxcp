...
class TestAuthenticationMiddleware:
    ...
    @pytest.fixture
    def middleware(self, mock_oauth_handler, mock_oauth_server):
    ...
    async def test_user_context_caching_basic(self, middleware, user_context):
    ...
    async def test_cache_expiration(self, middleware, user_context):
    ...
    async def test_cached_user_context_expiration_check(self):
    ...
    async def test_cleanup_removes_expired_entries(self, middleware, user_context):
    ...
    async def test_default_cache_ttl(self):
