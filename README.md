...
- **Cursor IDE** — Native MCP support with one-click installation
...
- [Integrations Guide](https://github.com/raw-labs/mxcp/blob/main/docs/guides/integrations.md) — Claude Desktop and Cursor IDE setup
